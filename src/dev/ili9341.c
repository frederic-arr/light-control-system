...
void ili9341_cmd_nop(void) { ili9341_wr_cmd(__ILI9341_CMD_RAMRD); }
...
void ili9341_cmd_ramwr(void) { ili9341_wr_cmd(__ILI9341_CMD_RAMWR); }

void ili9341_cmd_ramrd(void) { ili9341_wr_cmd(__ILI9341_CMD_RAMRD); }
...
void ili9341_zone_set_rel(uint16_t x1, uint16_t y1, uint16_t width,
                          uint16_t height) {
...
void ZONE_SET_REL_C(uint16_t x1, uint16_t y1, uint16_t width, uint16_t height) {
    ...
    ili9341_zone_set(x1 - half_w, y1 - half_h, x1 + half_w - 1,
                     y1 + half_h - 1);
}

void ili9341_zone_reset(void) { ili9341_zone_set(0, 0, 239, 319); }
